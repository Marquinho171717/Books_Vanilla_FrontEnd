        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(_subtitleController, 'Subtítulo (Opcional)', required: false),
              _buildTextField(_synopsisController, 'Sinopse', maxLines: 5),
              ...
              const SizedBox(height: 20),
              _buildTextField(_releaseDateController, 'Data de lançamento', hint: '13/12/1991'),
              _buildTextField(_isbnController, 'ISBN (Opcional)', required: false),
              _buildTextField(_authorController, 'Autor(a)'),
              _buildTextField(_priceController, 'Preço', prefixText: 'R\$'),
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: const Text('Cadastrar Livro', style: TextStyle(color: Colors.black)),
                ),
              ),
            ],
          ),
